                ...
                <form action="{{route('salvar')}}" method="post">
                    ...
                    <div class="col-md-6">         
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-black" id="login" name="login" value="{{$pessoa->CPF}}" placeholder="Número do CPF" maxlength="11" pattern="([0-9]{11})" required="true" >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pessoa" name="pessoa" value="{{$pessoa->NOME}}" required="true">
                        </div>                
